...
export default function MainPage() {
  return (
    <main className="bg-black overflow-hidden h-screen cursor-none relative">
        ...
        <div className="text-white flex flex-col gap-4">
          <div className="flex flex-col gap-0">
            ...
            <h6 className="text-[3.5vw] lg:text-[1.5vw] font-semibold text-white/60 capitalize flex flex-row items-center gap-1">
              ...
              <span className="text-white/90 font-bold arcivo-fonts">
                PT.ASLI
              </span>
            </h6>
          </div>
          ...
          <div className="flex flex-col gap-1 mt-2 lg:mt-6 z-10">
            ...
            <p className="lg:w-187.5 text-[3vw] lg:text-[1vw] text-white/50 leading-loose">
      ...
      <div className="absolute bottom-20 right-10 lg:bottom-20 lg:right-20">
        <img
          src={imageSrc}
          alt="sincan"
          className="w-[23vw] h-[23vw] lg:w-[10vw] lg:h-[10vw] rounded-full"
          draggable={false}
        />
      </div>
    </main>
